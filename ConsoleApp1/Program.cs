...
class Program
{
    ...
    public static async Task guardarEstudianteAsync()
    {
        ...
        await estudianteRepository.guardarEstudiante(student);

    }

    public static async Task guardarCursoAsync()
    {
        CursoRepository courseRepository = new CursoRepository();
        Course course = new Course();

        Console.WriteLine("Guardar Curso desde la clase Repository");
        Console.WriteLine("Ingrese el nombre del curso");
        course.CourseName = Console.ReadLine();
        await courseRepository.guardarCurso(course);
    }
